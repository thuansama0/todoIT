  ...
  return (
    ...
    >
      ...
      <View style={$contentContainer}>
        <Text style={[$title, !isRead && $titleUnread]} numberOfLines={1}>
          {title}
        </Text>
        <Text style={$content} numberOfLines={2}>
          {content}
        </Text>
...
const $containerUnread: ViewStyle = {
  backgroundColor: colors.palette.surfaceSoft,
...
const $unreadDot: ViewStyle = {
  ...
  borderRadius: spacing.xs / 2 + spacing.xxs / 2,
  backgroundColor: colors.palette.info500,
